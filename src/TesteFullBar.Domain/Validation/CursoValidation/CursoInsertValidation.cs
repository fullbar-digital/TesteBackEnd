...
{
    public class CursoInsertValidation : AbstractValidator<Curso>
    {
        private readonly ICursoRepository _cursoRepository;

        public CursoInsertValidation(ICursoRepository cursoRepository)
        {
        ...
        private async Task<bool> ValidationDescricao(Curso curso, CancellationToken cancellationToken)
        {
            ...
            return curso.Descricao != cursoRepository?.Descricao;
        }
    }
}
