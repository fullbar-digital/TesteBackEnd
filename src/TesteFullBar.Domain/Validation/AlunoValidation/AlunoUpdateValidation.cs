...
{
    public class AlunoUpdateValidation : AbstractValidator<Aluno>
    {
        private readonly IAlunoRepository _alunoRepository;

        public AlunoUpdateValidation(IAlunoRepository alunoRepository)
        {
        ...
        private async Task<bool> ValidationRA(Aluno aluno, CancellationToken cancellationToken)
        {
            ...
            return (alunoRepository?.Id) == aluno.Id;
        }
    }
}
